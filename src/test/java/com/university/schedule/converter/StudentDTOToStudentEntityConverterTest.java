...
public class StudentDTOToStudentEntityConverterTest {

    private StudentDTOToStudentEntityConverter studentDTOToStudentEntityConverterUnderTest;

    @BeforeEach
    void setUp() {
        studentDTOToStudentEntityConverterUnderTest = new StudentDTOToStudentEntityConverter();
    }
    ...
    public void convert_success() {
        ...
        Student studentFound = studentDTOToStudentEntityConverterUnderTest.convert(studentDTO);

        assertEquals(student.getGroup(), studentFound.getGroup());
        assertEquals(student.getRole(), studentFound.getRole());
        assertEquals(student.isEnable(), studentFound.isEnable());
        assertEquals(student.getFirstName(), studentFound.getFirstName());
        assertEquals(student.getLastName(), studentFound.getLastName());
