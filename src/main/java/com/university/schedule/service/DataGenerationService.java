...
public class DataGenerationService {
    ...
    private void generateScheduledClass(){
        ...
        DayScheduleItem dayScheduleItem = DayScheduleItem.builder()
                .course(course)
                .teacher(teacher)
                .classTime(classTimeService.findByOrderNumber(1))
                .dayOfWeek(DayOfWeek.MONDAY)
                .classType(classTypeService.findByName("Lecture"))
        ...
        dayScheduleItem = DayScheduleItem.builder()
                .course(course)
                .teacher(teacher)
                .classTime(classTimeService.findByOrderNumber(4))
                .dayOfWeek(DayOfWeek.MONDAY)
                .classType(classTypeService.findByName("Lecture"))
                .groups(new HashSet<>(groupList))
                .classroom(classroom)
        ...
        dayScheduleItem = DayScheduleItem.builder()
                .course(course)
                .teacher(teacher)
                .classTime(classTimeService.findByOrderNumber(2))
